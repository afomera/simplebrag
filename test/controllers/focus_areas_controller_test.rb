...
class FocusAreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create focus_area" do
    assert_difference("FocusArea.count") do
      post focus_areas_url, params: { focus_area: { color: @focus_area.color, name: @focus_area.name, user_id: @focus_area.user_id } }
    end
  ...
  test "should update focus_area" do
    patch focus_area_url(@focus_area), params: { focus_area: { color: @focus_area.color, name: @focus_area.name, user_id: @focus_area.user_id } }
